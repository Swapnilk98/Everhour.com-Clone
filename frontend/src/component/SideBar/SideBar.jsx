...
const SidebarContent = ({ onClose, ...rest }) => {
  return (
    <Box
      ...
      h="full"
      {...rest}>
      <Flex h="20" alignItems="center" mx="5" gap="10px">
...
const NavItem = ({ icon, children, ...rest }) => {
  return (
    <Link  as={ReachLink} to={children} style={{ textDecoration: 'none' }} _focus={{ boxShadow: 'none' }}>
      <Flex
        align="center"
        p="2"
        mx="4"
